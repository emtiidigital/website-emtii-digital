		                ...
		                echo '<div class="post-details margin-eight-top">';
		                    ...
		                    if( $brando_show_post_meta == 1 ){
			                    echo '<span class="text-small text-uppercase alt-font light-gray-text">';
			                        echo '<span class="published"><a href="'.get_permalink().'" class="light-gray-text">'.get_the_date($brando_date_format).'</a></span>'.esc_html__(' / Posted by','brando').' <span class="author vcard"><a href="'.get_author_posts_url( get_the_author_meta( 'ID' ) ).'" class="light-gray-text url fn n">'.get_the_author().'</a></span>';
