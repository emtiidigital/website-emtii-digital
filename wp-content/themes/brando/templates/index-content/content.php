...
$brando_show_post_meta = (isset($brando_options['brando_blog_page_show_post_meta'])) ? $brando_options['brando_blog_page_show_post_meta'] : '';
	                ...
	                echo'<div class="post-details margin-eight-top">';
	                    ...
	                    if( $brando_show_post_meta == 1 ){
		                    echo '<span class="text-small text-uppercase alt-font light-gray-text">';
		                        echo '<span class="published">'.get_the_date($brando_date_format).'</a></span>'.esc_html__(' / Posted by','brando').' <span class="author vcard"><a href="'.get_author_posts_url( get_the_author_meta( 'ID' ) ).'" class="light-gray-text url fn n">'.get_the_author().'</span>';
		                    echo'</span><time class="updated display-none" datetime="'.esc_attr( get_the_modified_date( 'c' ) ).'">'.get_the_modified_date( $brando_date_format ).'</time>';
	                	}
	                echo'</div>';
	            echo'</div>';
        	break;
