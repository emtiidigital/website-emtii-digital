                        ...
                        $brando_image_title = ( isset($brando_img_title['title']) && !empty($brando_img_title['title']) ) ? ' title="'.esc_attr($brando_img_title['title']).'"' : '';
                            ...
                            echo'<li '.$brando_post_classes.'>';
                                echo'<figure>';
                                    ...
                                    if($brando_url):
                                        $srcset = $srcset_data = '';
                                        $srcset = wp_get_attachment_image_srcset( get_post_thumbnail_id(get_the_ID()), $brando_portfolio_srcset_data );
                                        if( $srcset ){
                                            $srcset_data = ' srcset="'.esc_attr( $srcset ).'"';
                                        }
                                        echo '<div class="gallery-img">';
                                            echo '<a href="'.get_permalink().'"'.$brando_ajax_popup_class.'>';
                                                echo '<img src="'.esc_url($brando_url).'" width="'.$brando_thumb[1].'" height="'.$brando_thumb[2].'"'.$brando_image_alt.$brando_image_title.$srcset_data.'>';
                                            echo '</a>';
                                        echo '</div>';
                                    else : 
                            ...
                            echo'<li '.$brando_post_classes.'>';
                                echo'<figure class="overflow-hidden">';
                                    ...
                                    if($brando_url):
                                     ...
                                     echo'<figcaption>';
                                        if( get_the_title() ):
                                            echo'<h3 class="alt-font text-uppercase entry-title">'.get_the_title().'</h3>';
                                        endif;
                                    echo'</figcaption>';      
                                echo'</figure>';
                            echo'</li>';
                            ...
                            echo'<li '.$brando_post_classes.'>';
                                echo'<figure>';
                                    ...
                                    echo'<figcaption>';
                                        ...
                                        if( get_the_title() ){
                                            echo'<h3 class="alt-font text-uppercase white-text entry-title">'.get_the_title().'</h3>';
                                        }
                                        if( $brando_portfolio_subtitle ){
                        ...
                        while ( have_posts() ) : the_post();
                            ...
                            echo'<li '.$brando_post_classes.'>';
                                echo'<figure class="overflow-hidden">';
                                    ...
                                    echo'<figcaption>';
                                        if( get_the_title() ){
                                            echo'<h3 class="alt-font text-uppercase width-80 margin-lr-auto entry-title">'.get_the_title().'</h3>';
                                        }
                                    echo'</figcaption>';
                                echo'</figure>';
                            echo'</li>';
