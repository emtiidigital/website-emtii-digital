...
?>
    <nav class="navbar no-margin-bottom alt-font bg-white sidebar-nav<?php echo esc_attr($brando_header_text_color);?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 navbar-header margin-ten-bottom sm-no-margin">
                        ...
                        <?php if(!empty($brando_header_logo) || $brando_retina){ ?>
                                <a class="navbar-brand section-link" href="<?php echo esc_url($brando_logo_url); ?>">
                                    <?php
                    ...
                    <?php if( is_active_sidebar($brando_header_sidebar) ){ ?>
                            <div class="col-md-12 margin-ten no-margin-lr<?php echo $brando_call_to_action ?>">
