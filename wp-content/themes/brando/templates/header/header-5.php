...
?>
    <nav class="navbar no-margin-bottom alt-font without-button header-white bg-white<?php echo esc_attr($brando_header_text_color);?><?php echo $brando_enable_non_sticky;?>">
            <div class="container navigation-menu">
                <div class="row">
                    ...
                    <div class="col-md-2 navbar-header">
                        ...
                        ?>
                        <div class="collapse navbar-collapse col-lg-10 col-md-9 col-sm-9 accordion-menu<?php echo esc_attr($brando_right_sec); ?>" id="bs-example-navbar-collapse-1">
                            <?php
