...
?>
    <nav class="navbar no-margin-bottom alt-font center-logo-header no-border bg-turquoise-blue<?php echo esc_attr($brando_header_text_color);?><?php echo $brando_enable_non_sticky;?>">
            ...
            <div class="row text-center">
                <div class="navbar-header">
                    ...
                    <?php if(!empty($brando_header_logo) || $brando_retina){ ?>
                            <a class="navbar-brand inner-link logo" href="<?php echo esc_url($brando_logo_url); ?>">
                                <?php
                ...
                <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse text-center accordion-menu">
                    <?php
                ...
                ?>
                    <div class="col-lg-4 col-md-2 pull-right header-right text-right<?php echo $brando_call_to_action ?>">
