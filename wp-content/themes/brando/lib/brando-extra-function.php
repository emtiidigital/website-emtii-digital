                        ...
                        echo '<div class="col-text-middle-main">';
                            echo '<div class="col-text-middle">';
                                echo '<div class="col-md-12 col-sm-12 text-center">';
                                    echo '<h2 class="alt-font white-text font-weight-700 xs-title-extra-large no-margin entry-title">'.esc_attr($brando_page_title).'</h2>';
                                    echo '<div class="alt-font font-weight-600 title-small xs-text-large white-text text-uppercase margin-one-top display-block">'.esc_attr($brando_page_subtitle).'</div>';
                                echo '</div>';
                            echo '</div>';
                        echo '</div>';
                    echo '</div>';
...
function brando_enqueue_fonts_url() {
    ...
    if( $brando_theme_settings['alt_font']['font-family']){
        $brando_fonts[] = $brando_theme_settings['alt_font']['font-family'].':100,200,300,400,500,600,700,800,900';
    }else{
...
if ( ! function_exists( 'brando_image_size_for_archive' ) ):
    function brando_image_size_for_archive() {
        $sizes = array();
        $sizes = array(
                    'full' => esc_html__( 'Original Full Size', 'brando' ),
                    'brando-medium-thumb' => esc_html__( 'Medium (Width : 420px)', 'brando' ),
                    'medium_large' => esc_html__( 'Medium Large (Width : 768px)', 'brando' ),
                    'large' => esc_html__( 'Large (Width : 1024px)', 'brando' ),
                   );
       return $sizes;
    } 
endif;