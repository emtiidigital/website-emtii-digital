...
$this->sections[] = array(
    ...
    'fields' => array(
        ...
        array(
            'id'=>'brando_blog_srcset_data',
            'type' => 'select',
            'title' => esc_html__('Post Thumbnail Size', 'brando'),
            'options' => brando_image_size_for_archive(),
            'default' => 'full',
        ),
        array(
        ...
        array(
            'id'=>'brando_blog_page_show_post_date',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Date', 'brando'),
            'default' => true,
            'required'  => array('brando_blog_page_grid_layout', 'equals', array('grid') ),
        ),
        array(
          ...
          'default' => 'd m Y',
          'required'  => array('brando_blog_page_show_post_date', 'equals', array('1') ),
        ),
        array(
            'id'=>'brando_blog_page_show_post_author',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Author', 'brando'),
            'default' => true,
            'required'  => array('brando_blog_page_grid_layout', 'equals', array('grid') ),
        ),
        array(
        ...
        array(
            'id'=>'brando_blog_page_show_content',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Content', 'brando'),
            'default' => true,
            'required'  => array('brando_blog_page_grid_layout', 'equals', array('grid','classic') ),
        ),
        array(
        ...
        array(
            'id'=>'brando_blog_page_show_pagination',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Pagination', 'brando'),
            'default' => true,
            'required'  => array('brando_blog_page_grid_layout', 'equals', array('grid','classic') ),
        ),
        array(
        ...
        array(
            'id'=>'brando_enable_meta_category',
            'type' => 'switch', 
            'title' => esc_html__('Enable Post Meta Category', 'brando'),
            'default' => false,
        ),
        array(
        ...
        array(
            'id'=>'brando_srcset_data_portfolio',
            'type' => 'select',
            'title' => esc_html__('Portfolio Thumbnail Size', 'brando'),
            'options' => brando_image_size_for_archive(),
            'default' => 'full',
        ),
        array(
        ...
        array(
            'id'=>'brando_enable_meta_category_portfolio',
            'type' => 'switch', 
            'title' => esc_html__('Enable Post Meta Category', 'brando'),
            'default' => false,
        ),
        ...
        array(
            'id'=>'brando_general_show_post_date',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Date', 'brando'),
            'default' => true,
            'required'  => array('brando_general_grid_layout', 'equals', array('grid') ),
        ...
        array(
            'id'=>'brando_general_show_post_author',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Author', 'brando'),
            'default' => true,
            'required'  => array('brando_general_grid_layout', 'equals', array('grid') ),
         ...
         array(
          ...
          'title' => esc_html__('Date Format', 'brando'),
          'default' => 'd m Y',
          'required'  => array('brando_general_show_post_date', 'equals', array('1') ),
        ),
        array(
        ...
        array(
            'id'=>'brando_general_show_pagination',
            'type' => 'switch', 
            'title' => esc_html__('Show Post Pagination', 'brando'),
            'default' => true,
            'required'  => array('brando_general_grid_layout', 'equals', array('grid','classic') ),
        ...
        array(
            'id'=>'brando_portfolio_cat_srcset_data',
            'type' => 'select',
            'title' => esc_html__('Portfolio Thumbnail Size', 'brando'),
            'options' => brando_image_size_for_archive(),
            'default' => 'full',
        ...
        array(
            'id' => 'brando_portfolio_cat_title',
            'type' => 'text',
            'title' => esc_html__('Portfolio Page Title', 'brando'),
            'default' => 'Portfolio',
        ),
        array(
        ...
        array(
          ...
          array(
            'id'       => 'brando_enable_sticky_general',
            'type'     => 'switch',
        ...
        array(
            'id'       => 'brando_enable_callto_mobile_general',
            'type'     => 'switch',
            'title'    => esc_html__('Call to action in mobile', 'brando'),
            'default'  => false,
            'required'  => array('brando_header_layout_general', '!=', 'headertype2'),
        ),
        array(
            'id'        => 'opt-accordion-end-general',
            'type'      => 'accordion',
