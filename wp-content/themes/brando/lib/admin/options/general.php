...
?>
<?php
$accordian_content_start = $url_slug = $categories_url_slug = $tags_url_slug = $accordian_content_end = $brando_enable_under_construction = '';
if( class_exists('Brando_Addons') ) {
    ...
    /* Porfolio url slug change */
    $accordian_content_start = array(
            'id'        => 'opt-accordion-begin-general',
            'type'      => 'accordion',
            'title'     => esc_html__( 'Portfolio Rewrite / URL Settings', 'Brando' ),
            'subtitle'  => esc_html__( 'Set portfolio, categories and tags url slug. After updating slug in this setting please go to Settings > Permalinks and click Save Changes button to have this new url slug change affected in your overall website.', 'Brando' ),
            'position'  => 'start'
        );
    $url_slug = array(
            'id'        => 'brando_portfolio_url_slug',
            'type'      => 'text',
            'title'     => esc_html__('Portfolio URL Slug', 'Brando' ),
        );
    $categories_url_slug = array(
            'id'        => 'brando_portfolio_categories_url_slug',
            'type'      => 'text',
            'title'     => esc_html__('Categories URL Slug', 'Brando' ),
        );
    $tags_url_slug = array(
            'id'        => 'brando_portfolio_tags_url_slug',
            'type'      => 'text',
            'title'     => esc_html__('Tags URL Slug', 'Brando' ),
        );
