...
function brando_register_style_js() {
    ...
    wp_register_script( 'background-srcset', BRANDO_THEME_JS_URI.'/background-srcset.js',array('jquery'),BRANDO_THEME_VERSION,true);
...
function brando_load_vc_iframe_js() {
    wp_register_script( 'modernizr-js', BRANDO_THEME_JS_URI.'/modernizr.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'bootstrap-js', BRANDO_THEME_JS_URI.'/bootstrap.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-easing-js', BRANDO_THEME_JS_URI.'/jquery.easing.1.3.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'skrollr-js', BRANDO_THEME_JS_URI.'/skrollr.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'smooth-scroll-js', BRANDO_THEME_JS_URI.'/smooth-scroll.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'wow-js', BRANDO_THEME_JS_URI.'/wow.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-parallax-js', BRANDO_THEME_JS_URI.'/jquery.parallax-1.1.3.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'owl-carousel-js', BRANDO_THEME_JS_URI.'/owl.carousel.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-magnific-popup-js', BRANDO_THEME_JS_URI.'/jquery.magnific-popup.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'counter-js', BRANDO_THEME_JS_URI.'/counter.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-fitvids-js', BRANDO_THEME_JS_URI.'/jquery.fitvids.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'imagesloaded-pkgd-js', BRANDO_THEME_JS_URI.'/imagesloaded.pkgd.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-appear-js', BRANDO_THEME_JS_URI.'/jquery.appear.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'classie-js', BRANDO_THEME_JS_URI.'/classie.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'isotope-pkgd-js', BRANDO_THEME_JS_URI.'/isotope.pkgd.min.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-countTo-js', BRANDO_THEME_JS_URI.'/jquery.countTo.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'jquery-nav-js', BRANDO_THEME_JS_URI.'/jquery.nav.js',array('jquery'),BRANDO_THEME_VERSION,true);
    wp_register_script( 'infinite-scroll-js', BRANDO_THEME_JS_URI.'/infinite-scroll.js',array('jquery'),'2.1.0',true);
    wp_register_script( 'background-srcset-js', BRANDO_THEME_JS_URI.'/background-srcset.js',array('jquery'),BRANDO_THEME_VERSION,true);
