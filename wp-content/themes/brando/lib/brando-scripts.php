...
function brando_load_vc_iframe_js() {
    ...
    wp_register_script( 'brando-carousel', BRANDO_THEME_JS_URI . '/owl.carousel.min.js', array( 'jquery'), null, true );
    wp_enqueue_script('brando-carousel');

    wp_register_script( 'brando-main', BRANDO_THEME_JS_URI . '/main.js', array( 'jquery'), null, true );
    wp_enqueue_script('brando-main');
}
