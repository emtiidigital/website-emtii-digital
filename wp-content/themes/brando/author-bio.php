...
<div class="text-center bg-gray clear-both margin-six-bottom">
    <div class="blog-comment text-left clearfix no-margin padding-six-all">
        ...
        <div class="comment-text position-relative overflow-hidden">
            <h5 class="alt-font text-large dark-gray-text no-margin"><span class="author vcard"><a class="url fn n" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php esc_html_e( 'About The Author', 'brando' ); ?></a></span></h5>
